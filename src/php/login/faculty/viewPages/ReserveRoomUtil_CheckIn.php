...
$updateRoomQuery ="update ROOM_RESERVATION rr SET rr.\"ISCHECKEDOUT\"='Y',rr.\"EndTime\"=SYSTIMESTAMP  WHERE 
rr.\"RoomNumber\"='$RoomNumber' AND rr.\"Location\"='$Location'AND rr.\"StartTime\"='$StartTime' AND rr.\"UnityID\"='$UnityId'";
